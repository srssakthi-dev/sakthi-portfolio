...
export const projects: Project[] = [
  {
    slug: 'reading-habit-companion',
    title: 'Reading Habit Companion',
    category: 'Software Engineering',
    period: 'Sep 2026',
    summary: 'React Native + Expo app for building a consistent reading habit, with timed sessions, notes, and unlockable shelf themes.',
    bullets: [
      'Built a React Native / Expo app where users search Google Books, time reading sessions, and log page progress with notes and quotes',
      'Backed the app with Supabase (profiles, books, sessions, notes tables) secured with Row Level Security so each user can only access their own data',
      'Implemented a daily-goal streak system and a Trends screen with 7-day activity charts and session history',
      'Gamified progress with unlockable shelf themes that unlock after every three completed books',
    ],
    tech: ['React Native', 'Expo', 'Supabase', 'Google Books API'],
    thumbLabel: 'app screenshot',
    thumbIcon: icons.browser,
    repoUrl: 'https://github.com/srssakthi-dev/reading-habit-companion-snack',
    image: '/projects/reading-habit-companion-v1.png',
  },
  {
  ...
  },
  {
    ...
    tech: ['JavaScript', 'Web Audio API', 'Signal Processing', 'IndexedDB', 'p5.js'],
    thumbLabel: 'app screenshot',
  ...
  },
  {
    ...
    thumbIcon: icons.chart,
    repoUrl: 'https://github.com/srssakthi-dev/brain-tumor-classification-detection',
  ...
  },
  {
    ...
    thumbIcon: icons.chart,
    repoUrl: 'https://github.com/srssakthi-dev',
    notebookUrl: '/notebooks/comparative-text-classification.html',
  ...
  },
  {
    ...
    thumbIcon: icons.chart,
    repoUrl: 'https://github.com/srssakthi-dev',
    notebookUrl: '/notebooks/california-housing-price-prediction.html',
  ...
  },
  {
    ...
    thumbLabel: 'app screenshot',
    thumbIcon: icons.browser,
    repoUrl: 'https://github.com/srssakthi-dev/event-management-system',
  ...
  },
  {
    ...
    repoUrl: 'https://github.com/srssakthi-dev/crypto-trading-sim',
  ...
  },
  {
    ...
    thumbLabel: 'notebook plot',
    thumbIcon: icons.chart,
    repoUrl: 'https://github.com/srssakthi-dev/resume-analysis-nlp',
    image: '/projects/resume-bigfive-traits-v1.png',
    pipeline: ['CSV data', 'Preprocessing (NLTK)', 'Feature extraction', 'Big Five mapping'],
  },
  {
    slug: 'browser-platformer-game',
    title: 'Browser Platformer Game',
    category: 'Creative',
    period: 'Dec 2023',
    summary: 'Side-scrolling, Mario-style browser platformer built with p5.js.',
    bullets: [
      'Built a side-scrolling platformer in p5.js, including character movement, jump physics, and collision detection',
      'Implemented level scrolling and obstacle/enemy interactions',
    ],
    tech: ['p5.js', 'JavaScript', 'HTML5'],
    thumbLabel: 'gameplay screenshot',
    thumbIcon: icons.game,
    repoUrl: 'https://github.com/srssakthi-dev/browser-platform-game',
